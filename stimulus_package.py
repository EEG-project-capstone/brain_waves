...
def generate_and_play_sentences(num_sentences=4, patient_id="patient123",
				noun_words=noun_list.txt, adj_words=adj_list.txt,
				verb_words=verb_list.txt):
    ...
    who/what egg the stimulus is being administered to
    ...
    noun_list = noun_words
    adj_list = adj_words
    verb_list = verb_words
